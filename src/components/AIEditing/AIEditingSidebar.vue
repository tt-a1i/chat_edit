...
import { IconCode, IconFileText, IconBrush, IconTerminal } from '@tabler/icons-vue'
...
<template>
  <div class="w-64 border-r border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
    <div class="flex flex-col p-4">
      <h2 class="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">AI Editing</h2>
