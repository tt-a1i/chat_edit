    ...
    <div class="relative flex-1 flex justify-end min-w-0">
      <div class="relative max-w-[85%] group/bubble">
        ...
        >
          ...
          <div
            v-else
            class="prose prose-sm max-w-none dark:prose-invert prose-p:my-0 prose-headings:my-2 prose-a:text-teal-600 dark:prose-a:text-teal-400 prose-ul:my-0 prose-ol:my-0 prose-pre:my-0 [&_*:first-child]:mt-0 [&_*:last-child]:mb-0"
          >
